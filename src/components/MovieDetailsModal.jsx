    ...
    <>
      <div
        ...
        <div className="bg-white shadow-md dark:bg-[#12141D] rounded-2xl sm:grid sm:grid-cols-[2fr_1fr] overflow-hidden">
          <img className="sm:order-2 w-full object-cover h-full max-sm:max-h-[300px]" src={getImageUrl(movie?.cover)} alt={movie?.title} />
          <div className="p-5 lg:p-11">
            ...
            <div className="grid lg:grid-cols-2 gap-2">
              ...
              <button onClick={onCloseModal} className="border border-[#74766F] rounded-lg py-2 px-5 flex items-center justify-center gap-2 text-[#6F6F6F] dark:text-gray-200 font-semibold text-sm"
                href="#">
                Cancel
              </button>
            </div>
